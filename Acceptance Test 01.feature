...
Dado que el usuario está en la pantalla de registro emocional
Cuando selecciona los emojis y guarda el registro
Entonces el sistema almacena todas las emociones seleccionadas
Y si el usuario intenta seleccionar más de 3 emojis, se muestra un aviso
